			...
			foreach($stmt as $row){
				...
				$output .= "
					<tr>
						...
						<td><i class='fa fa-rupee'></i> ".number_format($row['price'], 2)."</td>
						...
						<td><i class='fa fa-rupee'></i> ".number_format($subtotal, 2)."</td>
					</tr>
				";
			}
			$output .= "
				<tr>
					...
					<td><b><i class='fa fa-rupee'></i> ".number_format($total, 2)."</b></td>
				<tr>
			";
